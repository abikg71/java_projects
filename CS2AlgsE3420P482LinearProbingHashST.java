...
//Chapter 1, Ex 3.4, Pro#20
// Abinet Kenore, MW 06:00 T0 07:50 CS 2050 Fall 2016,
import java.util.*;

public class CS2AlgsE3420P482LinearProbingHashST<Key, Value> {
    ...
    public CS2AlgsE3420P482LinearProbingHashST() {
        this(INIT_CAPACITY);
    }

    // create linear proving hash table of given capacity
    public CS2AlgsE3420P482LinearProbingHashST(int capacity) {
        M = capacity;
    ...
    private void resize(int capacity) {
        CS2AlgsE3420P482LinearProbingHashST<Key, Value> temp = new CS2AlgsE3420P482LinearProbingHashST<Key, Value>(capacity);
        for (int i = 0; i < M; i++) {
            if (keys[i] != null) {
   ...
   public static void main(String[] args) { 
        CS2AlgsE3420P482LinearProbingHashST<String, Integer> st = new CS2AlgsE3420P482LinearProbingHashST<String, Integer>();
