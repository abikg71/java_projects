...
public SBBSTNode()
     ...
     /* Constructor */
public SBBSTNode(int n, String rgn, String states, boolean dupDMACd,
...
public void deleteNode(int x, int treeReBalD)
 ...
 public SBBSTNode insert(int data, String region, String state, 
         boolean dupDMACode, int treeReBalD, int numTreeInsertD )
     {
       SBBSTNode y = new SBBSTNode(0, "", "", false, 0, 0);
       root = insert(data, region, state, dupDMACode, treeReBalD,
                     numTreeInsertD, root, y);
         return root;
     }
...
private SBBSTNode insert(int x, String rgon, String stt, 
  boolean dupDMAC, int tBalD, int nTreeInD, SBBSTNode t, SBBSTNode z)
     {
         if (t == null)
         {
...
private SBBSTNode delete(SBBSTNode root,int x,int treeReBalD,int numTreeInsertD)
 ...
 {    
  SBBSTNodeR leftR, rightR, parentR;
     ...
     /* Constructor */
public SBBSTNodeR(String rgn, int n, String states, boolean dupRgn, 
               int treeBalDR, int nmTreeInsertDR)
     {
         leftR = null;
         rightR = null;
         regionR = rgn;
...
/* Class SelfBalancingBinarySearchTree */
 class PreorderBalancedBSTR
 {
     ...
     /* Function to insert data */
  public SBBSTNodeR insertR(String regionR, int dataR, String stateR, 
...
private SBBSTNodeR deleteR(SBBSTNodeR rootR, String rgonR, int treeReBalDR,
           int numTreeInsertDR )
    {
   if (rootR == null)
            return rootR;
  ...
  if (rgonR.compareTo(rootR.regionR) < 0)
    ...
    rootR.parentR.numTreeInsertDR = rootR.parentR.numTreeInsertDR + 
                                      rootR.numTreeInsertDR;      
...
// CS2 is a course name
//Algs is a text book being used
//E32 means exrecise from 3.2
//P418 is page on the textbook
//HW4 is homework number and CPU is What is the program is doing
public class CS2AlgsE32P418HW4CPU {
   ...
   int duplicateRegionItems = 0;
    ...
    do    
    {
       ...
       + "1. insert, 2. search,3. count nodes,4. check empty,5. clear tree\n"
       + "6. delete from");
       System.out.println(" ");
       System.out.println("Following are options for the Region Key List\n"
        + "7.  insert,8.  search,9.  count nodes,10. check empty\n"
        + "11. clear tree, 12. delete from");
            ...
            case 0 :
             ...
             System.out.printf("\nPart 2, Metrics Number of times\n"
             + " tree rebalanced %d number of inserts %d\n", metricsVal[0], metricsVal[1]);       
            ...
            case 2 : 
                ...
                System.out.println("Search result : "+ sbbst3.search( console.nextInt() ));
                break;                                          
            case 3 : 
            ...
            case 6 : 
                ...
                int deleteItem = console.nextInt();
            ...
            case 8 : 
                ...
                System.out.println("Search result : "+ sbbst4.searchR( console.next() ));
                break; 
            case 9 : 
            ...
            case 12 : 
                ...
                System.out.println("Case sensitive, too.");
                String deleteItemR = console.next();
...
public static int readFile(String fileNm, PreorderBalancedBST sbbst,
                     PreorderBalancedBSTR sbbst2)
    {   
