...
/*
monthlyPayement = prinicpal + interest;
Monthlyinterest = rate * balance (remaing principl)
monthlypricipal = monthelypayement -interst
*/

import java.util.Scanner;

public class FinancialLoanApp
{
    public static void main(String[] args) {
        ...
        double monthinterst = rate * balance;
        monthlyPayement = principal - monthinterst;
        interst = rate *principal/100;

        System.out.println("\n========= Summary ========");
        System.out.println("Years\t\tInterst\t   Principal\t\t\t");
        System.out.println(years + "\t\t\t" + interst + "\t\t" + principal);
        System.out.println(years + "\t\t\t" + interst + "\t\t" + principal);
        System.out.println(years + "\t\t\t" + interst + "\t\t" + principal);
        System.out.println(years + "\t\t\t" + interst + "\t\t" + principal);
